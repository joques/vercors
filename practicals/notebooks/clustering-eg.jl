...
apsat_df = DataFrame(CSV.File("../dataset/cls-train.csv", header=1))

# ╔═╡ d231c777-67eb-4952-bcfe-7ea92417921e
select!(apsat_df, Not([:Column1, :id, :satisfaction]))
...
grp_part1 = MLJ.predict(cls_mach2, X_pca[1:40000,:])

# ╔═╡ fd9d1532-d793-4eb9-a18d-49ef0d5d203c
levels(grp_part1)

# ╔═╡ 1e026654-aec3-434d-aebe-46fba49761f4
